...
public class HuanweiProjectAdapter extends BaseAdapter {
    List<HuanweiAPI.HuanweiProjectEntity> list;
    Context mContext;

    public HuanweiProjectAdapter(List<HuanweiAPI.HuanweiProjectEntity> list, Context mContext) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        vh.textView.setText(list.get(i).xm);
        return view;
    }
