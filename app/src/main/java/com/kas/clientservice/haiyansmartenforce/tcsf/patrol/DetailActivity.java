...
import com.kas.clientservice.haiyansmartenforce.tcsf.widget.FullyGridLayoutManager;
import com.zhy.http.okhttp.OkHttpUtils;


public class DetailActivity extends TitleActivity implements View.OnClickListener{
    ...
    public void queryDetail() {
        ...
        OkHttpUtils.post().url(HTTP_HOST.URL_BERTHDETAIL)
                .addParams("Btid", btid)
