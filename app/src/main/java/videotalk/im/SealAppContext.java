...
import videotalk.im.message.module.SealExtensionModule;
import videotalk.im.server.broadcast.BroadcastManager;
import videotalk.im.server.network.http.HttpException;
import videotalk.im.server.pinyin.CharacterParser;
import videotalk.im.server.response.ContactNotificationMessageData;
