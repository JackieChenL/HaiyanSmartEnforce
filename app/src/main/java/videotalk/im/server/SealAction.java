...
import videotalk.im.server.network.http.HttpException;
import videotalk.im.server.request.AddGroupMemberRequest;
import videotalk.im.server.request.AgreeFriendsRequest;
import videotalk.im.server.request.ChangePasswordRequest;
import videotalk.im.server.request.CheckPhoneRequest;
import videotalk.im.server.request.CreateGroupRequest;
import videotalk.im.server.request.DeleteFriendRequest;
import videotalk.im.server.request.DeleteGroupMemberRequest;
import videotalk.im.server.request.DismissGroupRequest;
import videotalk.im.server.request.FriendInvitationRequest;
import videotalk.im.server.request.JoinGroupRequest;
import videotalk.im.server.request.LoginRequest;
import videotalk.im.server.request.QuitGroupRequest;
import videotalk.im.server.request.RegisterRequest;
import videotalk.im.server.request.RestPasswordRequest;
import videotalk.im.server.request.SendCodeRequest;
import videotalk.im.server.request.SetFriendDisplayNameRequest;
import videotalk.im.server.request.SetGroupDisplayNameRequest;
import videotalk.im.server.request.SetGroupNameRequest;
import videotalk.im.server.request.SetGroupPortraitRequest;
import videotalk.im.server.request.SetNameRequest;
import videotalk.im.server.request.SetPortraitRequest;
import videotalk.im.server.request.VerifyCodeRequest;
import videotalk.im.server.response.AddGroupMemberResponse;
import videotalk.im.server.response.AgreeFriendsResponse;
import videotalk.im.server.response.ChangePasswordResponse;
import videotalk.im.server.response.CheckPhoneResponse;
import videotalk.im.server.response.CreateGroupResponse;
import videotalk.im.server.response.DefaultConversationResponse;
import videotalk.im.server.response.DeleteFriendResponse;
import videotalk.im.server.response.DeleteGroupMemberResponse;
import videotalk.im.server.response.DismissGroupResponse;
import videotalk.im.server.response.FriendInvitationResponse;
import videotalk.im.server.response.GetFriendInfoByIDResponse;
import videotalk.im.server.response.GetGroupInfoResponse;
import videotalk.im.server.response.GetGroupMemberResponse;
import videotalk.im.server.response.GetGroupResponse;
import videotalk.im.server.response.GetTokenResponse;
import videotalk.im.server.response.GetUserInfoByIdResponse;
import videotalk.im.server.response.GetUserInfoByPhoneResponse;
import videotalk.im.server.response.GetUserInfosResponse;
import videotalk.im.server.response.JoinGroupResponse;
import videotalk.im.server.response.LoginResponse;
import videotalk.im.server.response.QiNiuTokenResponse;
import videotalk.im.server.response.QuitGroupResponse;
import videotalk.im.server.response.RegisterResponse;
import videotalk.im.server.response.RestPasswordResponse;
import videotalk.im.server.response.SendCodeResponse;
import videotalk.im.server.response.SetFriendDisplayNameResponse;
import videotalk.im.server.response.SetGroupDisplayNameResponse;
import videotalk.im.server.response.SetGroupNameResponse;
import videotalk.im.server.response.SetGroupPortraitResponse;
import videotalk.im.server.response.SetNameResponse;
import videotalk.im.server.response.SetPortraitResponse;
import videotalk.im.server.response.SyncTotalDataResponse;
import videotalk.im.server.response.UserRelationshipResponse;
import videotalk.im.server.response.VerifyCodeResponse;
import videotalk.im.server.response.VersionResponse;
import videotalk.im.server.utils.NLog;
import videotalk.im.server.utils.json.JsonMananger;
