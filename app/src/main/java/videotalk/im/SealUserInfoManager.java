...
import videotalk.im.db.DBManager;
import videotalk.im.db.Friend;
import videotalk.im.db.FriendDao;
import videotalk.im.db.GroupMember;
import videotalk.im.db.GroupMemberDao;
import videotalk.im.db.Groups;
import videotalk.im.db.GroupsDao;
import videotalk.im.db.UserInfoBean;
import videotalk.im.server.SealAction;
import videotalk.im.server.network.async.AsyncTaskManager;
import videotalk.im.server.network.async.OnDataListener;
import videotalk.im.server.network.http.HttpException;
import videotalk.im.server.pinyin.CharacterParser;
...
import videotalk.im.server.utils.RongGenerate;
