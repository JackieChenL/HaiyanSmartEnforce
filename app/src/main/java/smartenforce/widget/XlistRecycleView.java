...
public class XlistRecycleView extends RecyclerView {
    ...
    public XlistRecycleView(Context context) {
        this(context, null);
    }

    public XlistRecycleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XlistRecycleView(Context context, AttributeSet attrs, int defStyle) {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    XlistRecycleView.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    XlistRecycleView.this.setVisibility(View.VISIBLE);
                }
            }
        }
